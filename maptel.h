...
/*
 * Makro opisujące maksymalną długość nr-u telefonu
 */
 ...
 * @param tel_src numer początkowy
 * @param tel_dst numer docelowy
 */
 ...
 * @param tel_src numer początkowy
 * @param tel_dst numer docelowy
 * @param len rozmiar przydzielonej pamięci wskazywanej przez tel_dst
 */
